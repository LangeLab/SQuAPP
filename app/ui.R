if (READY){
  ...
  fluidPage(
    tags$h1("SQuAPP Undergoing Updates"),
    tags$p("We apologize for the inconvenience, but our application is currently undergoing updates."),
    tags$p("Please check back later for new content.")
  )
}
